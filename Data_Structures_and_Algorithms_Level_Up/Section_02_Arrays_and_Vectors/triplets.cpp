 ...
 * find all distinct integers that can add up to form the target sum. The
 * numbers in each triplet should be ordered in ascending order, and the
 * triplets should be ordered also.
